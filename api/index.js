...
function buildFinalPrompt(userData) {
    // Добавлена = {} для безопасности, как и советовал "эксперт"
...
* **B&P: Shape Smart Food (Коктейли: Клубника, Капучино, Дыня):** Классический белковый коктейль-заменитель пищи. 
    * *Порция 25г:* К:272, Б:48.1, Ж:0.3, У:30.1, Клетч:14.2 
...
* **B&P: Shape Smart Food vegan (Крем-супы):** Горячий, сытный, веганский ОБЕД или УЖИН. 
    * *(Грибной, 25г):* К:324, Б:44.0, Ж:6.8, У:21.7, Клетч:15.6 
    * *(Зелёный, 25г):* К:388, Б:50.4, Ж:7.6, У:29.5, Клетч:17.6 
    * *(Томатный, 25г):* К:336, Б:42.8, Ж:5.6, У:28.6, Клетч:16.4 
...
* **B&P: Пюре Re:Balance (Картофельное: С Беконом, Грибное, Прямо с грядки):** Горячее картофельное пюре с белком. 
    * *Порция 30г:* (Прим. К:363-367, Б:32-32.7, Ж:5.3, У:46.8-47.3, Клетч:10) 
    * *Приготовление:* 30г смеси + 120-150мл горячей воды (65-85°C), размешать, настоять 2-3 мин. 
* **B&P: Detox Gentle (Каша Завтрак "Яблочный Пирог"):** "Умный" сбалансированный ЗАВТРАК (каша) для энергии и здоровья ЖКТ. 
    * *Порция 50г:* К:384, Б:32.4, Ж:10.0, У:41.1, Клетч:8.2 
    * *(Примечание: КБЖУ в файле дано на 100г, порция 50г, значит реальные КБЖУ порции: К:192, Б:16.2, Ж:5, У:20.5, Клетч:4.1)*
...
* **B&P: Coffee Flat White (Горячий и Холодный):** Протеиновый кофе. Может заменить перекус. 
    * *Горячий (Порция 22г):* К:322.7, Б:60.9, Ж:3.2, У:12.6, Клетч:9.5 (Примечание: КБЖУ на 100г). *Приготовление:* 22г в пасту с 30-50мл хол. воды, затем + 150-250мл гор. воды (~80°C). 
    * *Холодный (Порция 22.5г):* К:302.2, Б:52.0, Ж:7.1, У:7.6 (Примечание: КБЖУ на 100г). *Приготовление:* 22г + 200-300мл хол. воды в шейкере. 
* **B&P: It's Fiber (Яблоко-Корица):** Пребиотический детокс-напиток. 
    * *Порция 10г:* К:210, Б:4.0, Ж:1.0, У:46.3, Клетч:84.0 (Примечание: КБЖУ на 100г).
    * *Приготовление:* 10г + 250мл воды комн. t°, быстро размешать и выпить. 3 режима (Профилактика, Восстановление, SOS). 
* **B&P: Prebiotik Mix (Яблоко-Корица):** Напиток с пребиотиками для баланса микрофлоры. 
    * *Порция 10г:* К:212.5, Б:1.4, Ж:0.15, У:4.6, Клетч:48.2 (Примечание: КБЖУ на 100г).
...
* **B&P: Herbal Mix (ИММУНИТЕТ):** Согревающий чай для поддержки иммунитета. 
    * *Порция 3.5г:* К:171.4, Б:2.9, Ж:5.7, У:27.1, Клетч:28.6 (Примечание: КБЖУ на 100г).
...
* **B&P: Herbal Mix Smart Food (Классика):** Тонизирующий травяной напиток (термодженик). 
    * *Порция 1.7г:* К:352.9, Б:0.1, Ж:0.1, У:87.9 (Примечание: КБЖУ на 100г).
    * *Приготовление:* 1.7г (1/2 ч.л.) + 250мл горячей воды (70-80°C). 
* **B&P: Herbal Mix Smart Food (Печёночный):** Напиток для поддержки печени. 
    * *Порция 5г:* К:352.9, Б:0.1, Ж:0.1, У:87.9 (Примечание: КБЖУ на 100г).
...
* **B&P: Best Protein Smart Food (Нейтральный):** Чистый изолят соевого белка. 
    * *Порция 22.3г:* К:335, Б:88.0, Ж:1.0, У:3.0 (Примечание: КБЖУ на 100г).
...
* **IF {ЦЕЛЬ} == 'похудение':**
    ...
    * ***Акцент B&P (Оптимизация):*** "Чтобы *гарантировать* дефицит калорий и высокий белок, не 'перегрузив' ЖКТ на ночь, Shape Smart Food (Категория 1: Еда/Коктейль или Суп) или Пюре Re:Balance (Категория 1: Еда/Пюре) - Ваша идеальная замена ужина. Они дают сытость и белок без лишних углеводов и жиров".
* **IF {ЦЕЛЬ} == 'набор массы':**
...
3.  **Стратегия Баланса (ВАЖНО - Двойной Подход):**
    ...
    * **ОБЯЗАТЕЛЬНЫЙ ПРИМЕР ЛОГИКИ:** "Я вижу у Вас дефицит белка в {X}г. Мы уже закрыли {Y}г 'Умным Коктейлем' на завтрак ('Золотой Стандарт'). Оставшийся дефицит в {Z}г можно решить двумя путями:
        ...
        * *Вариант 2 (Сбалансированный):* На обед съесть [100г индейки с порцией гречки и овощами], а на ужин использовать [Пюре Re:Balance (Категория 1)], чтобы гарантированно добрать белок без лишних углеводов на ночь".
...
3.  **"Золотой Стандарт" (Обязательный План):** (Подробное описание Завтрака (3 шага) и Перекуса в 16:00-17:00 с *объяснениями* из 5.1, **используя подсказки о категориях**).
