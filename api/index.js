...
* **IF {ЦЕЛЬ} == 'антипаразитарная программа':**
    ...
    * *Акцент B&P:* "Detox Gentle и Herbal Mix помогают выводить токсины. Shape Smart Food (несладкие вкусы) и Пюре Re:Balance (Грибное лукошко, Прямо с грядки) - это те 'безопасные' продукты, которые Вы можете себе позволить, чтобы не сорваться".
